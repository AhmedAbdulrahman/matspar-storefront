...
const FormControlBoxRoot = styled('div', {
  ...
  '--_edge': 'var(--matspar-form-control-box-edge, 11px)',
  '--_inset': 'var(--matspar-form-control-box-inset, 52px)',
  '--_spacing': `var(--matspar-form-control-box-spacing, ${theme.spacing(2)})`,
  position: 'relative',
  ...(ownerState.divider && {
